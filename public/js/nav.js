...
!(function () {
  ...
  window.kadence = {
    ...
    toggleSubMenu: function (e, t) {
      ...
      if (
        ...
        for (let e = 0; e < s.length; e++)
          window.kadence.toggleSubMenu(s[e], !1);
      ...
      if (
        ...
        document.addEventListener("keydown", function (e) {
          ("Tab" === e.key || 9 === e.keyCode) &&
            (e.shiftKey
              ? document.activeElement === d && (l.focus(), e.preventDefault())
    ...
    initStickyHeader: function () {
      ...
      parseInt(kadenceConfig.breakPoints.desktop) < window.innerWidth
        ? ((a = "desktop"),
          e &&
            ...
            (s = window.kadence.getOffset(e).top),
            (e.style.position = null)))
        : t &&
          ((t.style.position = "static"),
          (s = window.kadence.getOffset(t).top),
      ...
      var d,
        ...
        u = function (d) {
          ...
          if (
            ...
            kadenceConfig.breakPoints.desktop <= window.innerWidth
              ? "mobile" === a
                ? ((s = window.kadence.getOffset(l).top), (a = "desktop"))
                : d &&
                  "updateActive" === d &&
                  ((l.style.top = "auto"),
                  (s = window.kadence.getOffset(l).top),
                  (a = "desktop"))
              : "desktop" === a
              ? ((s = window.kadence.getOffset(l).top), (a = "mobile"))
              : d &&
                "updateActive" === d &&
                ((l.style.top = "auto"),
                (s = window.kadence.getOffset(l).top),
            ...
            if (
              ((!p ||
                (d && void 0 !== d.type && "orientationchange" === d.type)) &&
                ...
                h.classList.contains("site-header-upper-inner-wrap")
                  ? ((h.style.height = null),
                    d && void 0 !== d.type && "orientationchange" === d.type
                      ? l.classList.contains("item-is-fixed")
                        ? setTimeout(function () {
                            h.style.height =
                              Math.floor(h.offsetHeight + l.offsetHeight) +
                              "px";
                          }, 21)
                        : setTimeout(function () {
                  ...
                  ? ((h.style.height = null),
                    (h.style.height = h.offsetHeight + "px"))
                  : (h.style.height = l.offsetHeight + "px")),
              "true" === w)
            ) {
              ...
              if (y) {
                if ("true" === m)
                  if (window.scrollY > r)
                    var v = Math.floor(
                      Math.floor(s) - Math.floor(c) + Math.floor(p)
                    );
            ...
            if ("true" === m) {
              ...
              if (E <= A) l.style.transform = "translateY(0px)";
                ...
                l.classList.add("item-hidden-above"),
                  (l.style.transform =
                    "translateY(" + (Math.abs(H) > q ? -q : H) + "px)");
              else {
                A = Math.floor(s - c);
                (l.style.transform = "translateY(" + (H > 0 ? 0 : H) + "px)"),
      ...
      if (
        ...
        (d = document.querySelector(".woocommerce-store-notice")),
          (l = (e) => {
            u("updateActive");
          }),
          (c = {
  ...
  function delayedInit() {
    console.log("kadence init called after 3 seconds");
    window.kadence.init();
  }
  ...
  if (document.readyState === "loading") {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      setTimeout(delayedInit, 3000); // 3 seconds delay
    });
  } else {
    // If the DOM has already loaded, run the initialization after the delay
    setTimeout(delayedInit, 3000); // 3 seconds delay
  }
})();
