        ...
        >
          <div class="tribe-common-l-container tribe-events-l-container">
            <div class="tribe-events-calendar-latest-past">
              ...
              <!-- Waiting for data -->
              <LoadingData v-if="pending" label="Weekly Gatherings" />

              <!-- Data is empty or has an error -->
              <EmptyData
                v-if="!data?.stories?.length && !pending"
...
const { pending, data } = await useFetch(
  "https://api.storyblok.com/v2/cdn/stories?starts_with=all-gatherings&token=jmrSXvK178kWedQ67oQLoAtt",
  {
    lazy: true,
    headers: {
